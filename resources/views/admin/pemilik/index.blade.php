...
<div class="container-fluid px-4">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h2>Data Pemilik</h2>
                <p>Kelola dan pantau data pemilik dalam sistem</p>
            </div>
            <a href="{{ route('admin.pemilik.create') }}" class="btn-add-new">
            ...
            <table class="data-table">
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        ...
                        <td class="owner-name">{{ $p->user_nama ?? '-' }}</td>
                    ...
                    <tr id="emptyRow">
                        <td colspan="5">
                            <div class="empty-state">
                                ...
                                <p>Belum ada data pemilik yang tersedia</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('keyup', function() {
        ...
        for (let i = 0; i < rows.length; i++) {
            ...
            // Search in nama and no_wa columns (index 1, 2)
            for (let j = 1; j <= 2; j++) {
                if (cells[j]) {
