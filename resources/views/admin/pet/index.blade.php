...
<div class="container-fluid px-4">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h2>Data Pet</h2>
                <p>Kelola dan pantau data pet dalam sistem</p>
            </div>
            <a href="{{ route('admin.pet.create') }}" class="btn-add-new">
                <i class="bi bi-plus-circle me-2"></i>Tambah Pet
            </a>
        </div>
    </div>
        ...
        <div class="search-section">
            <div class="search-wrapper">
                <div class="search-box">
                    ...
                    <input type="text" 
                           id="searchInput" 
                           placeholder="Cari berdasarkan nama, pemilik, atau ras...">
                </div>
            </div>
        </div>
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 150px;">Ras Hewan</th>
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        <td class="text-center">
                            <span class="id-badge">{{ $p->idpet }}</span>
                        </td>
                        <td class="pet-name">{{ $p->nama }}</td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('keyup', function() {
        ...
        for (let i = 0; i < rows.length; i++) {
            ...
            // Search in nama, ras, and pemilik columns (index 1, 5, 6)
            const searchIndices = [1, 5, 6];
            for (let idx of searchIndices) {
                if (cells[idx]) {
