...
<div class="container mt-5">
    <div class="card shadow-sm border-0 rounded-4">
        ...
        <div class="card-header text-white" style="background-color: #0d6efd;">
            <h4 class="mb-0 fw-semibold">Data Kategori Klinis</h4>
        </div>
            ...
            <table class="table table-bordered text-center align-middle table-hover shadow-sm rounded">
                <thead style="background-color: #cfe2ff;">
                    <tr>
                        ...
                        <th class="fw-semibold">Nama Kategori Klinis</th>
                        <th class="fw-semibold">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($kategori_klinis as $no => $k)
                        <tr>
                            <td>{{ $no + 1 }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-muted">Belum ada data kategori klinis</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
