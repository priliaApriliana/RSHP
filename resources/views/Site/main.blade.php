...
<body>
    ...
    <header class="site-header">
        <div class="header-left">
            <img src="{{ asset('assets/img/LOGO_UNAIR-removebg-preview.png') }}" class="logo" alt="Logo UNAIR">
    ...
    <nav class="main-nav">
        <ul>
            ...
            <li><a class="{{ request()->routeIs('visi') ? 'active' : '' }}" href="#">Visi Misi & Tujuan</a></li>

            @auth
                <li>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="logout-btn">Logout ({{ Auth::user()->nama }})</button>
                    </form>
                </li>
            @else
