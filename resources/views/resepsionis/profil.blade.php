...
@section('page-title', 'Profil Resepsionis')
    ...
    <div class="col-lg-4">
        <div class="card profile-card border-0 shadow-sm">
            <div class="card-header gradient-header-blue text-white text-center py-4 border-0">
                <h5 class="mb-0 fw-bold">Profil Resepsionis</h5>
            </div>
            <div class="card-body text-center p-4">
                ...
                <p class="text-muted mb-4">Resepsionis Klinik</p>
                <hr class="my-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="form-control-plaintext">
                            <span class="badge" style="background: linear-gradient(135deg, #8AAEE0 0%, #628ECB 100%);">
                                {{ $roleUser->nama_role ?? 'Resepsionis' }}
                            </span>
                        </p>
                    </div>
                    <div class="col-md-6">
