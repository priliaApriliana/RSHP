                ...
                <form action="{{ route('resepsionis.pemilik.update', $pemilik->idpemilik) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" class="form-control form-control @error('nama') is-invalid @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" class="form-control form-control @error('email') is-invalid @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="no_wa" class="form-control form-control @error('no_wa') is-invalid @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="alamat" class="form-control form-control @error('alamat') is-invalid @enderror" 
                    ...
                    <div class="card-footer border-top" style="background-color: #F0F3FA;">
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn" style="background: linear-gradient(135deg, #628ECB 0%, #395686 100%); color: white; border: none; flex: 1;">
                                <i class="bi bi-save me-2"></i>Simpan
                            </button>
                            <a href="{{ route('resepsionis.pemilik.index') }}" class="btn btn- btn-secondary" style="flex: 0.5;">
