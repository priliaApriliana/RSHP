...
@section('styles')
<link rel="stylesheet" href="{{ asset('assets/css/resepsionis/edit.css') }}">
@endsection
                ...
                <form action="{{ route('resepsionis.temudokter.update', $temuDokter->idreservasi_dokter) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" value="{{ $temuDokter->no_urut }}" disabled style="background-color: #F0F3FA;">
                        </div>
                        ...
                        <div class="mb-4">
                           ...
                           <select name="status" class="form-select" required>
                                <option value="A" {{ $temuDokter->status == 'A' ? 'selected' : '' }}>Antri</option>
                                <option value="B" {{ $temuDokter->status == 'B' ? 'selected' : '' }}>Batal</option>
                            </select>
